...
| **Reviewed By** | PENDING |
| **Approved By** | PENDING |
| **Distribution** | Qualified Vendors, Procurement Team, Architecture Team |

## Revision History

| Version | Date | Author | Changes | Approved By | Approval Date |
|---------|------|--------|---------|-------------|---------------|
| 1.0 | 2025-10-17 | Cabinet Office Enterprise Architecture Team | Initial SOW/RFP issuance | PENDING | PENDING |
| 1.1 | 2026-01-26 | ArcKit AI | Updated to align with ArcKit template v0.11.2 | PENDING | PENDING |

## Document Purpose

This Statement of Work (SOW) serves as the official Request for Proposal (RFP) document for the Exchange Online Migration project. It defines requirements, deliverables, evaluation criteria, and contract terms for qualified vendors responding to RFP-CAB-2025-001.
...
|------|------|-----------|------|
| CTO | [NAME] | _________ | PENDING |
| SIRO | [NAME] | _________ | PENDING |
| Procurement Director | [NAME] | _________ | PENDING |
| Legal Review | [NAME] | _________ | PENDING |
