...
|----------|---------|------|------|
| Requirements Document | 1.0 | 2025-10-17 | `projects/001-exchange-online-migration/requirements.md` |
| Architecture Principles | 1.0 | 2025-10-15 | `.arckit/memory/architecture-principles.md` |
| Container Diagram (HLD) | 1.0 | 2025-10-20 | `projects/001-exchange-online-migration/diagrams/container-m365-exchange-online.md` |
| Statement of Work | 1.0 | 2025-10-17 | `projects/001-exchange-online-migration/sow.md` |
| Evaluation Criteria | 1.0 | 2026-01-23 | `projects/001-exchange-online-migration/evaluation-criteria.md` |
...
|---------|------|--------|---------|
| 1.0 | 2026-01-23 | ArcKit AI | Initial draft from `/arckit.traceability` command |
